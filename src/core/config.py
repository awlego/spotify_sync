...
class Config:
    ...
    def _load_spotify_config(self) -> SpotifyConfig:
        ...
        return SpotifyConfig(
            ...
            redirect_uri=spotify.get('redirect_uri', os.getenv('SPOTIPY_REDIRECT_URI', 'http://localhost:6006/callback')),
    ...
    def _load_playlist_configs(self) -> Dict[str, PlaylistConfig]:
        ...
        for name, config in playlists_config.items():
            ...
            try:
                ...
                import logging
                logging.warning(f"Invalid configuration for {name} playlist: {e}. Skipping.")
